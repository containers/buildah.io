...
```
Again these aren't the most extensive examples, but they both illustrate how a main image can be setup and then a secondary container image can then be created with just a few steps.  This way the steps that are set up with the ONBUILD instructions don't have to be typed in each and every time that you need to setup your container.
...
[Introduction Tutorial]: https://github.com/containers/buildah/blob/main/docs/tutorials/01-intro.md
